...
SECRET_KEY = 'django-insecure-einpi!0%aazmh4k=#kod=@)3p5#=66$p0y)9du0*ays7v)uc@r'
...
USE_I18N = True # A boolean that specifies whether Django’s translation system should be enabled. This provides a way to turn it off, for performance. 
